...
if platform.system() != "Darwin" or platform.architecture()[0] != "64bit" or platform.machine() not in ["AMD64","x86_64"]: raise InstallationError("Invalid system/platform/architecture")
...
class install(setuptools.command.install.install):
    ...
    """
    libdir   = ['../../bin']
    instlibs = ['libtbb.12.5.dylib', 'libtbb.12.dylib', 'libmosek64.10.0.dylib']
